            ...
            if (lambarka_sirta == pin) {
                ...
                switch (code) {
                    ...
                    case 8:
                        ...
                        switch (bill_payment) {
                            case 1:
                                System.out.println("Haraaga Bill-ka waa: $500.00 (simulated)");
                                break;
                            case 2:
                                System.out.print("Geli lacagta: ");
                                double fullBill = input.nextDouble();
                                if (fullBill <= haraaga) {
                                    haraaga -= fullBill;
                                    System.out.printf("Waxaad bixisay Bill dhan $%.2f. Haraaga: $%.2f%n", fullBill, haraaga);
                                } else {
                                    System.out.println("Haraaga kuguma filna.");
                                }
                                break;
                            case 3:
                                System.out.print("Geli qaybta lacagta: ");
                                double partial = input.nextDouble();
                                if (partial <= haraaga) {
                                    haraaga -= partial;
                                    System.out.printf("Waxaad bixisay qayb ka mid ah Bill $%.2f. Haraaga: $%.2f%n", partial, haraaga);
                                } else {
                                    System.out.println("Haraaga kuguma filna.");
                                }
                        }
